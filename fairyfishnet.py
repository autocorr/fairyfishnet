...
[makhill:makruk]
flagPiece = k
flagRegionWhite = d4 d5 e4 e5
flagRegionBlack = d4 d5 e4 e5
...
# Promoted merc - gains non-capture movement to the sides as well and can capture up to 2 squares forward diagonally
...
customPiece8 = g:pRmR
# Eastern Bishop - A bishop that can also move sideways any number of squares without capturing
customPiece9 = z:BmsR
